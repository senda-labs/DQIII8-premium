---
name: mobilize
description: Multi-agent coordination protocol for tasks spanning 3+ distinct domains. Decomposes goal into sub-tasks, spawns specialized agents in isolated worktrees, aggregates results.
command: /mobilize
