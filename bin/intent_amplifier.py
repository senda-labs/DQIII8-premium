...
def amplify(
    ...
    amplified = _build_amplified_prompt(prompt, decomp, intent, domains, chunks)
    ...
    _log_amplification(prompt, amplified, decomp, intent, domains, tier, elapsed_ms)
