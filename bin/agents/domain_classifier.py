...
DOMAINS: dict[str, dict] = {
    "formal_sciences": {
        "keywords": [
            ...
            "geometría",
            "probabilidad",
            # numerical methods / algorithms (specific terms)
            "newton-raphson",
            "newton raphson",
            "convergence rate",
        ...
        "description": "Mathematics, logic, statistics, computation, algorithms, theorems, proofs, probability theory, numerical methods, convergence, complexity, statistical tests",
    },
    "natural_sciences": {
        "keywords": [
            "physics",
        ...
        "description": "Physics, chemistry, biology, ecology, geology, astronomy, nutrition, diet, BMR, TDEE, meal planning, supplements, physical constants, CODATA, pKa, buffers, metabolic pathways",
    },
    "social_sciences": {
        "keywords": [
            "economics",
        ...
        "description": "Economics, psychology, sociology, politics, marketing, SEO, advertising, finance, portfolio management, risk management, business, law, public tenders, procurement, macroeconomics, IS-LM, monetary policy",
    },
    "humanities_arts": {
        "keywords": [
            "literature",
            ...
            "calque",
            "modulation",
            # logic / fallacy identification (stronger multi-word hits)
        ...
        "description": "Literature, philosophy, history, art, music, linguistics, culture, ethics, creative writing, novels, fiction, poetry, logic, fallacies, translation, rhetoric, moral philosophy",
    },
    "applied_sciences": {
        "keywords": [
            "engineering",
        ...
        "description": "Engineering, medicine, technology, software development, web development, programming, React, TypeScript, C++, databases, APIs, DevOps, infrastructure, ML engineering, RAG, LLMs, embeddings, SQL patterns",
    },
}
