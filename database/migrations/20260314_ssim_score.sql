-- Migration: add ssim_score and ssim_quality columns to objectives
-- Applied: 2026-03-14

ALTER TABLE objectives ADD COLUMN ssim_score REAL DEFAULT NULL;
ALTER TABLE objectives ADD COLUMN ssim_quality TEXT DEFAULT NULL;

-- Recreate benchmark_results view with avg_ssim_score
